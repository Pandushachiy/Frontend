...
public final class ChatViewModel_Factory implements Factory<ChatViewModel> {
  ...
  public ChatViewModel get() {
    return newInstance(chatRepositoryProvider.get(), authRepositoryProvider.get(), documentRepositoryProvider.get(), voiceInputManagerProvider.get(), voiceRepositoryProvider.get(), savedStateHandleProvider.get());
  }
  ...
  public static ChatViewModel_Factory create(Provider<ChatRepository> chatRepositoryProvider,
      ...
      Provider<VoiceRepository> voiceRepositoryProvider,
      Provider<SavedStateHandle> savedStateHandleProvider) {
    return new ChatViewModel_Factory(chatRepositoryProvider, authRepositoryProvider, documentRepositoryProvider, voiceInputManagerProvider, voiceRepositoryProvider, savedStateHandleProvider);
  }
  ...
  public static ChatViewModel newInstance(ChatRepository chatRepository,
    ...
    return new ChatViewModel(chatRepository, authRepository, documentRepository, voiceInputManager, voiceRepository, savedStateHandle);
  }
}
