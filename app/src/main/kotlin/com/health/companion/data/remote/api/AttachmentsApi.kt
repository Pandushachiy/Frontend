...
interface AttachmentsApi {
    ...
    /**
     * Статус обработки вложения (OCR/Vision).
     * Полить каждые 2 сек, максимум 30 раз.
     * processing → файл ещё распознаётся
     * ready      → OCR завершён
     * failed     → ошибка распознавания
     */
    @GET("attachments/{conversationId}/{attachmentId}/status")
...
data class AttachmentStatusResponse(
    ...
    val processingStatus: String,               // "processing" | "ready" | "failed"
    @SerialName("has_text")
